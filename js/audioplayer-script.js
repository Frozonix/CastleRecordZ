if( window.innerWidth <= 540 ){
      ...
      document.getElementById("random-text").innerHTML = setRandomText
 } else {
      let setRandomText = "RANDOM"
...
$(document).ready(function () {
  ...
  elGain.addEventListener("mouseup", function onMouseup(){
    document.onmousemove = null
  });
  ...
  elTimeline.addEventListener("mouseup", function onMouseup(){
    document.onmousemove = null
  ...
  let cover = {
    a0: (document.getElementById("a0").style.backgroundImage =
      "url('img/audioplayer/covers/default.png')"),
  ...
  var tracklist = [
    (track1 = ["a0", "tracklist/Magna beats – Водопад.mp3"]),
    (track2 = ["a1", "tracklist/Magna beats – Водопад.mp3"]),
    (track3 = ["a2", "tracklist/Magna beats – Водопад.mp3"]),
    (track4 = ["a3", "tracklist/Magna beats – Водопад.mp3"]),
    (track5 = ["a4", "tracklist/Magna beats – Водопад.mp3"]),
    (track6 = ["a5", "tracklist/Magna beats – Водопад.mp3"]),
    (track7 = ["a6", "tracklist/Magna beats – Водопад.mp3"]),
    (track8 = ["a7", "tracklist/Magna beats – Водопад.mp3"]),
    (track9 = ["a8", "tracklist/Magna beats – Водопад.mp3"]),
    (track10 = ["a9", "tracklist/Magna beats – Водопад.mp3"]),
    (track11 = ["a10", "tracklist/Magna beats – Водопад.mp3"]),
    (track12 = ["a11", "tracklist/Magna beats – Водопад.mp3"]),
  ];
